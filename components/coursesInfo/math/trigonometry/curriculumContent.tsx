        ...
        <div className={contentStyle}>
          <div className={contentItemStyle}>
            ...
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 1: Introduction to Trigonometry</p>
          ...
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 2: Trigonometric Functions</p>
          ...
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 3: Right Triangle Trigonometry</p>
              <p className={contentDurationStyle}>2-3Hrs</p>
              <p className={pinkBackgroundStyle}>4 Topics</p>
            </div>
          </div>
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 4: The Unit Circle</p>
              <p className={contentDurationStyle}>2Hrs</p>
              <p className={pinkBackgroundStyle}>4 Topics</p>
            </div>
          </div>
