        ...
        <div className={contentStyle}>
          <div className={contentItemStyle}>
            ...
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 1: The Cell - Structure and Function</p>
          ...
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 2: Genetics and Heredity</p>
          ...
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 3: Photosynthesis and Cellular Respiration</p>
              <p className={contentDurationStyle}>2-3Hrs</p>
              <p className={pinkBackgroundStyle}>2 Topics</p>
            </div>
          </div>
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 4: Ecosystems and Biodiversity</p>
              <p className={contentDurationStyle}>2Hrs</p>
              <p className={pinkBackgroundStyle}>2 Topics</p>
            </div>
          </div>
          <div className={contentItemStyle}>
            ...
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Video: Introduction to Biology</p>
      ...
      {selectedWeek === 'week2' && (
        <div className={contentStyle}>
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 5: Trigonometric Identities</p>
          ...
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 6: Trigonometric Equations</p>
              <p className={contentDurationStyle}>2Hrs</p>
              <p className={pinkBackgroundStyle}>4 Topics</p>
            </div>
          </div>
          <div className={contentItemStyle}>
            <span className={contentIconStyle}><PiNotebookBold /></span>
            <div className={contentDetailsStyle}>
              <p className={contentTitleStyle}>Module 7: Inverse Trigonometric Functions</p>
              <p className={contentDurationStyle}>2-3Hrs</p>
              <p className={pinkBackgroundStyle}>4 Topics</p>
            </div>
          </div>
