...
const MoreInfo: React.FC<MoreInfoProps> = () => {
  const videoSrc = "https://www.youtube.com/embed/bka20Q9TN6M";
  const courseDuration = '2-5 hours';
  const courseDescription = 'This is a comprehensive course that covers Chemistry in detail...';
  ...
  return (
    <Card>
       <CardHeader className="text-center">
        <CardTitle className="text-2xl font-bold">CHEMISTRY CONTENT</CardTitle>
        <CardDescription>
      ...
      <div style={navigationContainerStyle}>
        ...
        <div style={headerImageStyle}>
          <h1 style={headingStyle} className="">
            Unlock the Power of Equations: Join our Chemistry Adventure!
          </h1>
          <img
            src="https://img.freepik.com/free-vector/molecular-structure-molecular-structural-coding-illustration_1284-52871.jpg?w=740&t=st=1691761166~exp=1691761766~hmac=29c8def20f9e85dccdc352e8535b83818f21266b79f1086e26064aefda7025c5"
            alt="Header Image"
