...
const menuItems: MenuItem[] = [
  { id: 1, label: "UNIT 1", unitLabel: "Introduction to Algebra", link: "/courses/units/math/algebra/unit1" },
  { id: 2, label: "UNIT 2", unitLabel: "Solving Linear Equations", link: "/courses/units/math/algebra/unit2" },
  { id: 3, label: "UNIT 3", unitLabel: "Graphing Linear Equations", link: "/courses/units/math/algebra/unit3" },
  { id: 4, label: "UNIT 4", unitLabel: "Systems of Linear Equations", link: "/courses/units/math/algebra/unit4" },
];
...
const Sidebar: React.FC = () => {
  ...
  const collapseIconClasses = classNames(
    "p-4 mb-2 rounded bg-light-lighter absolute right-0",
    {
            ...
            <div className="flex items-center ">
             <svg
              ...
              <h1 className="text-xl">
                <span
                  className={classNames("mt-2 ml-2 font-bold text-2xl text-uppercase text-text", {
              ...
              <div className={`${classes}`} key={menu.id}>
                <Link href={menu.link}
                  className={classNames(
                    ...
                    "hover:bg-blue-50 dark:hover:bg-gray-400" // Add this class for blue hover effect
                  )}>
